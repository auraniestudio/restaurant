    ...
    <footer className="bg-charcoal text-cream">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
          {/* Brand */}
          <div>
            <h3 className="font-serif text-2xl font-semibold text-white mb-4">Lumière Restaurant</h3>
            <p className="text-cream/80 text-sm leading-relaxed">
              A refined dining experience in the heart of the city.
            </p>
          </div>

          {/* Address */}
          <div>
            <h4 className="font-serif text-lg font-medium text-gold mb-3">Address</h4>
            <address className="text-cream/80 text-sm not-italic leading-relaxed">
          ...
          {/* Hours & Contact */}
          <div>
            <h4 className="font-serif text-lg font-medium text-gold mb-3">Opening Hours</h4>
            <p className="text-cream/80 text-sm leading-relaxed">
              Mon – Thu: 6:00 PM – 10:00 PM<br />
              Fri – Sun: 5:30 PM – 11:00 PM
            </p>
            <h4 className="font-serif text-lg font-medium text-gold mt-4 mb-3">Contact</h4>
            <a href="tel:+15551234567" className="text-cream/80 text-sm hover:text-gold transition-colors">
              +1 (555) 123-4567
            </a>
          </div>
          ...
          {/* Social */}
          <div>
            <h4 className="font-serif text-lg font-medium text-gold mb-3">Follow Us</h4>
